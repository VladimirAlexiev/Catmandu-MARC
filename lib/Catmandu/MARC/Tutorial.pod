...
=head2 Create a CSV file of all ISSN numbers found at any MARC field
...
On line 03 we filter out this array all the lines that contain an ISSN string using a regular expression.
...
Run this Fix script (without the line numbers) using this command
