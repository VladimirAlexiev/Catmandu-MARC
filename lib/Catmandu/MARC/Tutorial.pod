...
=head2 Setting and removing MARC indicators
...
MARC tag isn't repeatable this loop isn't needed.) With marc_map we copy
...
This will provide a tab delimited file of duplicate isbn numbers in the MARC
input file.
